...
public class JavaConfigXmlOper {

    private static Logger logger = LoggerFactory.getLogger(JavaConfigXmlOper.class);

    private static String filePath = "config/xml/JavaConfig.xml";
